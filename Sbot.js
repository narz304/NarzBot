...
//Conectando o reconectando
        ...
        console.log('⌛ 𝗜𝗡𝗜𝗖𝗜𝗔𝗡𝗗𝗢 𝗘𝗦𝗣𝗘𝗥𝗔 𝗦𝗘𝗡𝗣𝗔𝗜 >𝗪< ')
        })

//La conexión fue en éxito
        client.on('open', () => {
        console.log('✓ 𝗖𝗢𝗡𝗘𝗖𝗧𝗔𝗗𝗢 𝗘𝗫𝗜𝗧𝗢𝗦𝗔𝗠𝗘𝗡𝗧𝗘 𝗢𝗡𝗜-𝗖𝗛𝗔𝗡')
        })
...
case 'bot':
client.sendMessage(from, 'Hola, acabas de lograrlo senpai >w<', text, {quoted : sam})
break
